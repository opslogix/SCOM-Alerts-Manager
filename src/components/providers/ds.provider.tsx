...
interface DsContextProps {
    ...
    updateAlertResolutionState: (alertId: string, resolutionState: string) => Promise<void>;
}
...
export const DsProvider = ({ children, datasource, query, onChange, onRunQuery }: DsProviderProps) => {
    ...
    const values = {
        ...
        updateAlertResolutionState: async (alertId: string, resolutionState: string) => {
            await datasource.getResource('updateAlertResolutionState', { alertId, resolutionState });
        },
        query
    }
